...
function fullScreenTo() {
    video.classList.toggle('player-full-screen');
    playerControls.classList.toggle('player-controls-full-screen');
}
...
fullScreenButton.addEventListener('click', fullScreenTo);
